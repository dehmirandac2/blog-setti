...
?>
	...
	<div class="wrapper">
		<div id="container">
			<div id="content" class="listando-textos">
				<ul id="breadcrumb">
						<li><a href="<?php echo site_url(); ?>">Início</a><span>></span></li>
						<li><a href="<?php echo site_url('textos'); ?>">Textos</a></li>
						<li><? echo (isset($_GET['categoria']) ? '>  ' .$titulo->name : ''); ?></li>
					</ul>
				<div>
					<div class="second-header-intern">
						<h2 class="entry-title" style="margin-bottom: 10px">Textos
...
<p>Fiquei no <i>JB</i> de 1986 a 1990. Os artigos abaixo incluem também colaborações posteriores, de outra fase do jornal. As mais de mil notas para diferentes colunas do <i>JB</i> que produzi no período -- como o "Informe JB", pilotado por Ancelmo Gois, e a igualmente prestigiosa coluna de Zózimo Barrozo do Amaral -- estão no espaço intitulado, justamente, "Notas para colunas". </p>
					...
					<div class="third-header-intern">
						<div class="second-navigation">
							<span class="text-select">Mais textos de:</span>
                      ...
                      <!--  <? foreach ( $results as $post ) : setup_postdata($post); ?>
						<div class="hold-search">
                        	<?php if ( has_post_thumbnail() ) : ?>
								<a href="<? the_permalink(); ?>" class="img-search"><?php the_post_thumbnail( array(279,150) ); ?></a>
                            <?php endif; ?>    							

		    				<h3><a href="<? the_permalink(); ?>"><? the_title(); ?></a></h3>
							<p><? the_excerpt_limit('30'); ?></p>
							<div>
								...
								<span class="readmore"><a href="<? the_permalink(); ?>">Continue lendo</a></span>
							</div>
						</div>
                        <? endforeach; ?> -->
                        ...
                        <div class="float-left">
							...
							<dl class="gallery-item">
								<dt class="gallery-icon">
			                        ...
			                        ?>
									<!--<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('full', array('class' => 'thumb-100')); ?></a>-->
								</dt>

								<dd class="title-gallery-caption"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></dd>
