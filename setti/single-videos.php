...
?>
	...
	<div class="wrapper">
		<div id="container">
			<div id="content" class="video-grande">
				<div>
					<ul id="breadcrumb">
				...
				<div style="width: 602px" class="wp-caption">
					<h4 title="<?php the_title_attribute(); ?>"><? the_title(); ?></h4>
					<div class="entry-meta-post">Postado em <?php the_date() ?> às <?php the_time() ?></div>
					<div class="video-full"><? the_field('endereco_do_video');?></div>
