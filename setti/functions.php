...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Widgets da Sidebar', ''),
        'description' => __('Widgets da Barra Lateral', ''),
        'id' => 'widget-area-1',
...
function pagination_per_category($count)
{
    global $wp_query;
    $big = 999999999;
    echo paginate_links(array(
        ...
        'total' => ceil($count/10)//$wp_query->max_num_pages
    ));
}
...
?>
    ...
    <div class="comment-meta commentmetadata">
		<?php
			printf( __('- Postado em %1$s ás %2$s'), get_comment_date(),  get_comment_time()) ?><?php edit_comment_link(__('(Edit)'),'  ','' );
		?>
	</div>
