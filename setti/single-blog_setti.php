		...
		<div id="container">
			<div id="content">
				<ul id="breadcrumb">
						...
						<li><a href="<?php echo site_url('textos'); ?>">Blog Setti</a><span>></span></li>
						<li><? the_title(); ?></li>
					</ul>
				<h2 class="entry-title" style="border-bottom:1px solid #d7d7d7; padding-bottom:20px; margin-bottom:20px; width: 100%">Blog Setti</h2>
