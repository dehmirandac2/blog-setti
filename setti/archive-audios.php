<?php get_header(); ?>
            ...
            <div id="content" class="audios">
                <div>
                    ...
                    <div class="second-header-intern">
                        <h2 class="entry-title" style="margin-bottom: 10px">Áudios
    ...
    <?php if ($args['term'] == "blog-veja"){ ?>
                                <p>O desafio sedutor, irresistível, apareceu na fase madura de minha carreira, depois de haver deixado por vontade própria a Editora Abril e funções executivas exercidas por longos anos ali e em outros veículos: criar um blog no site da revista Veja , para tratar dos assuntos que bem entendesse, e da forma que achasse melhor.
</p>
                            ...
                            <?php if ($args['term'] == "folha-de-sao-paulo"){ ?>
                                Texto do Folha de São Paulo
                            <?php } ?>
                            <?php if ($args['term'] == "estadao"){ ?>
                                Texto do O Estado de São Paulo
                            <?php } ?>
                    ...
                    <div class="third-header-intern">
                        <div class="second-navigation">
                            <span class="text-select">Mais áudios de:</span>
                    ...
                    <div class="entry-content">                        
                        <div class="gallery">
                            ...
                            <dl class="gallery-item">
                                <dt class="gallery-icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icone-audio.jpg"/></dt>
                                <dd class="gallery-caption"><h5><? the_title(); ?></h5><? the_content(); ?></dd>
                            </dl>
                            <? endforeach; ?>    
                        </div>
                    </div>
